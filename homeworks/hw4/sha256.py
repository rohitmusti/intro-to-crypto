...
# 5.3.3 SHA-256
# For SHA-256, the initial hash value, H
# (0), shall consist of the following eight 32-bit words, in
# hex:
# FROM: https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.180-4.pdf
INITIAL_HASH_VALUES = [
    "0x6a09e667",
...
def sha256(message):
    k = initializer(CONSTANTS_256)
    h0, h1, h2, h3, h4, h5, h6, h7 = initializer(INITIAL_HASH_VALUES)
